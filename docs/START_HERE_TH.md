...
ในโฟลเดอร์ที่เขียนได้และอยู่นอก repo **ไม่จำเป็นต้องเสียบ SSD** ผู้ใช้อนุญาตให้
Codex เลือกพื้นที่บนเครื่องใหม่เองได้ เช่นโฟลเดอร์ข้อมูลแอปของผู้ใช้สำหรับไฟล์ audit
ที่ต้องเก็บต่อ หรือโฟลเดอร์ชั่วคราวของระบบสำหรับไฟล์ที่ทิ้งได้ ให้ตรวจพื้นที่ว่าง
หลีกเลี่ยงโฟลเดอร์แชร์/cloud sync และแจ้งตำแหน่งที่เลือกไว้ ไม่ต้องรอ SSD หรือถามซ้ำ
เพียงเพราะไม่มี SSD ส่วน DICOM, pixel cache และ weights ขนาดใหญ่ยังอยู่บน Kaggle
